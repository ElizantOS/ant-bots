...
// Static media/font assets remain byte-pinned for visual parity. JavaScript
// dependencies are resolved from package.json and must be emitted by the clean
// source graph, never allowlisted as opaque renderer chunks.
