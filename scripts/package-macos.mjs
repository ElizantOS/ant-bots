...
if (sourceFlag && fidelityFlag) {
  throw new Error("Choose one package mode: --source or --fidelity.");
}
const fidelity = fidelityFlag;
// The default package is the fully editable clean-source graph. The fidelity
// profile is opt-in and exists only for byte-level comparison with the release.
const { builtAsar, builtAsarUnpacked, runtimeApp } = fidelity
