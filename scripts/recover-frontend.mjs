...
const sourceRenderer = process.env.SAND_RECOVER_SOURCE_RENDERER?.trim()
  ? path.resolve(process.env.SAND_RECOVER_SOURCE_RENDERER.trim())
  : path.join(sourceAppDir, "dist", "renderer");
