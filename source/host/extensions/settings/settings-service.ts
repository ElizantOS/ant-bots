...
export interface HostSettingsUpdate {
  ...
  sidebarSections?: SidebarSection[]; hasSeenOnboarding?: boolean; featureFlagOverrides?: Record<string, boolean>; inferenceProvider?: unknown; inferenceModels?: Record<string, unknown>;
}
...
export class SettingsService {
  ...
  setHostSettings(update: HostSettingsUpdate) {
    ...
    if (update.inferenceModels !== undefined && typeof update.inferenceModels === "object" && update.inferenceModels != null && !Array.isArray(update.inferenceModels)) this.store.setInferenceModels(update.inferenceModels as Partial<Record<SandInferenceProvider, string>>);
  ...
  getInferenceModels() { return this.store.getInferenceModels(); }
  getInferenceModel(provider?: SandInferenceProvider) { return this.store.getInferenceModel(provider); }
