...
import { resolveCursorAgentCliPath } from "../../../shared/node/inference-router-local.js";
...
export function createCursorSandInference(options: CursorSandInferenceOptions): CursorSandInference {
  ...
  return {
    ...
    createSession(onRequestId, sessionOptions) {
      ...
      if (routedProvider === "cursor" && resolveCursorAgentCliPath() != null) return createProviderPromptSession("cursor") as unknown as CursorPromptSession;
