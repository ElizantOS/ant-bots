...
export const MAIN_METHOD_TABLE = {
  ...
  setHostSidebarSections: "object", getAvailableModels: "none", getInferenceRouter: "none", setInferenceRouter: "object", setInferenceModel: "object", transcribeAudio: "object", getCursorAuthStatus: "none",
...
export interface KnownMainRpcArguments {
  ...
  setInferenceRouter: { provider: string };
  setInferenceModel: { provider?: string; model: string | null };
