...
export type InferenceProviderId = "cursor" | "claude-code" | "codex" | "opencode" | "openrouter";
export interface InferenceRouterSnapshot {
...
export interface AgentDesktopBridge {
  ...
  getInferenceRouter(): Promise<InferenceRouterSnapshot>;
  setInferenceRouter(provider: InferenceProviderId): Promise<InferenceRouterSnapshot>;
  setInferenceModel(model: string | null, provider?: InferenceProviderId): Promise<InferenceRouterSnapshot>;
  clientPersistence: {
