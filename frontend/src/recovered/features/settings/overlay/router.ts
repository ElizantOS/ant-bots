export type RouterProviderId = "cursor" | "claude-code" | "codex" | "opencode" | "openrouter";
...
export const ROUTER_PROVIDERS: readonly RouterProvider[] = [
  {
    id: "cursor",
    label: "Cursor Agent",
    description: "Use the Cursor Agent CLI session already signed in on this Mac.",
    usageDescription: "Requests run through the local Cursor Agent CLI.",
  ...
  },
  {
    id: "opencode",
    label: "OpenCode",
    description: "Use the OpenCode CLI and its configured provider credentials.",
    usageDescription: "Requests run through your local OpenCode configuration.",
    usageSource: "external"
  },
  {
    id: "openrouter",
