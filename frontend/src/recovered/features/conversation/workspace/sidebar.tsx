...
import { SandContextMenu, SandMenuContent, SandMenuItem, SandMenuRoot, SandMenuTrigger, SandTooltip } from "../../../ui/sand-floating-primitives";
      ...
      <header className="sand-agents-sidebar__header">
        <div className={isCollapsed ? "sand-agents-sidebar__rail-new" : "sand-agents-sidebar__new-actions"}>
          {!isCollapsed && hasCollaborationActions ? <>
            {onBroadcast == null ? null : <SandIconButton aria-label="Broadcast to agents" className="sand-agents-sidebar__broadcast" icon="megaphone" label="Broadcast to agents" onClick={onBroadcast} size="sm" />}
          ...
          <SandTooltip content="New chat">
            <SandIconButton aria-label="New" className="sand-agents-sidebar__new" icon="plus" label="New" onClick={onNewChat} size={isCollapsed ? "md" : "sm"} shape={isCollapsed ? "circle" : "square"} title="New chat" />
          </SandTooltip>
        </div>
      </header>
