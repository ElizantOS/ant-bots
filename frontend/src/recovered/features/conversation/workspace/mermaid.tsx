// @evidence src/app/package.json#mermaid=^11.16.0
// @evidence src/app/dist/renderer/assets/index-UbX-y3il.js#lazy-mermaid
...
export async function loadShippedMermaidRuntime(): Promise<MermaidRuntime> {
  ...
  if (runtime == null || typeof runtime.initialize !== "function" || typeof runtime.parse !== "function" || typeof runtime.render !== "function") {
