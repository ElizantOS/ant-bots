// @evidence src/app/package.json#katex=0.16.45
// @evidence src/app/dist/renderer/assets/index-UbX-y3il.js#lazy-katex
...
export async function loadShippedKatexRuntime(): Promise<KatexRuntime> {
  ...
  if (typeof runtime.renderToString !== "function") throw new Error("KaTeX runtime is unavailable.");
  return {
    renderToString: (expression, options) => runtime.renderToString(expression, options),
  };
}
